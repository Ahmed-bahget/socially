...
import { HeartIcon, LogInIcon, MessageCircle, SendIcon } from 'lucide-react';
...
// Define the like type
type Like = Post['likes'][number];
            ...
            <div className='flex-1 min-w-0'>
              <div className='flex items-start justify-between'>
                <div className='flex flex-col sm:flex-row sm:items-center sm:space-x-2 truncate'>
                  ...
                  <div className='flex text-sm space-x-2 text-muted-foreground items-center'>
